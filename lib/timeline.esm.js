...
function drawHelper({ timeSpacing, screenScaleCount, xOffset, scaleSpacing, scaleHeight, startTime, endTime, timeOffset, drawLine, drawText, }) {
    if (timeSpacing === 1) {
