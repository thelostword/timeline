...
function drawHelper({ timeSpacing, screenScaleCount, xOffset, scaleSpacing, scaleHeight, startTime, timeOffset, drawLine, drawText, }) {
    if (timeSpacing === 1) {
...
class TimeLine {
    constructor(id, { fill = false, width, height, bgColor = 'rgba(0,0,0,0.5)', textColor = '#ffffff', scaleColor = '#ffffff', areaBgColor = '#ffffff55', pointColor = '#00aeec', pointWidth = 3, scaleSpacing = 5, }) {
        ...
        __classPrivateFieldSet(this, _TimeLine_timeSpacing, 1, "f");
    ...
    draw({ currentTime = Math.floor(Date.now() / 1000), areas, _privateFlag }) {
        console.time('draw');
        ...
        this.currentTime + screenSecondCount / 2;
    ...
    drawText(x, y, text, color = this.textColor) {
        this.canvasContext.beginPath();
    ...
    drawArea(startTime, endTime, bgColor) {
        ...
        const startX = (centerTimePoint - xOffset) + Math.floor((startTime - this.currentTime) / __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f")) * this.scaleSpacing;
        const endX = (centerTimePoint - xOffset) + Math.floor((endTime - this.currentTime) / __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f")) * this.scaleSpacing;
        this.canvasContext.beginPath();
