...
var _TimeLine_event, _TimeLine_timeSpacingMap, _TimeLine_timeSpacing, _TimeLine_pointHeight;
class TimeLine {
    constructor(id, fill = false) {
        var _a, _b;
        ...
        if (fill) {
            ...
            this.$canvas.width = (_a = this.$canvas.parentNode) === null || _a === void 0 ? void 0 : _a.clientWidth;
            this.$canvas.height = (_b = this.$canvas.parentNode) === null || _b === void 0 ? void 0 : _b.clientHeight;
    ...
    draw({ startTime, endTime, currentTime, areas }) {
        ...
        const beforePointCount = Math.ceil((this.currentTime - this.startTime) / __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f"));
        const afterPointCount = Math.ceil((this.endTime - this.currentTime) / __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f"));
        ...
        if (__classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") === 5) {
            for (let i = 0; i < beforePointCount; i++) {
                const x = centerTimePoint - i * this.spacing - xOffset;
                const time = this.currentTime - i * __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") - timeOffset;
                if (time % (60 * 60) === 0) {
                    this.drawLine(x, __classPrivateFieldGet(this, _TimeLine_pointHeight, "f").hour1);
                    this.drawText(x - 30, 20, `${dateTime(time)}`);
                    continue;
                }
                if (time % (60 * 30) === 0) {
                    this.drawLine(x, __classPrivateFieldGet(this, _TimeLine_pointHeight, "f").minute30);
                    this.drawText(x - 30, 20, `${dateTime(time)}`);
                    continue;
                }
                if (time % (60 * 10) === 0) {
                    this.drawLine(x, __classPrivateFieldGet(this, _TimeLine_pointHeight, "f").minute10);
                    this.drawText(x - 15, 20, `${dateTime(time, 'HH:mm')}`);
                    continue;
                }
                if (time % 60 === 0) {
                    this.drawLine(x, __classPrivateFieldGet(this, _TimeLine_pointHeight, "f").minute1);
                    this.drawText(x - 15, 20, `${dateTime(time, 'HH:mm')}`);
                    continue;
                }
                if (time % 5 === 0) {
                    this.drawLine(x, __classPrivateFieldGet(this, _TimeLine_pointHeight, "f").second5);
                    continue;
                }
            }
        ...
        if (__classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") === 10) {
            for (let i = 0; i < beforePointCount; i++) {
                const x = centerTimePoint - i * this.spacing - xOffset;
                const time = this.currentTime - i * __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") - timeOffset;
                if (time % (60 * 60) === 0) {
        ...
        if (__classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") === 30) {
            for (let i = 0; i < beforePointCount; i++) {
                const x = centerTimePoint - i * this.spacing - xOffset;
                const time = this.currentTime - i * __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") - timeOffset;
                if (time % (60 * 60) === 0) {
        ...
        if (__classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") === 60) {
            for (let i = 0; i < beforePointCount; i++) {
                const x = centerTimePoint - i * this.spacing - xOffset;
                const time = this.currentTime - i * __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") - timeOffset;
                if (time % (60 * 60) === 0) {
        ...
        if (__classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") === 120) {
            for (let i = 0; i < beforePointCount; i++) {
                const x = centerTimePoint - i * this.spacing - xOffset;
                const time = this.currentTime - i * __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") - timeOffset;
                if (time % (60 * 60) === 0) {
        ...
        if (__classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") === 300) {
            for (let i = 0; i < beforePointCount; i++) {
                const x = centerTimePoint - i * this.spacing - xOffset;
                const time = this.currentTime - i * __classPrivateFieldGet(this, _TimeLine_timeSpacing, "f") - timeOffset;
                if (time % (60 * 60) === 0) {
...
_TimeLine_event = new WeakMap(), _TimeLine_timeSpacingMap = new WeakMap(), _TimeLine_timeSpacing = new WeakMap(), _TimeLine_pointHeight = new WeakMap();
