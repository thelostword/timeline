 ...
 * @LastEditTime: 2022-09-05 12:31:31
 * @FilePath: \timeline\src\index.d.ts
 */
export declare type AreaItemState = {
  startTime: number;
  endTime: number;
  bgColor?: string;
}
...
export declare type ScaleHeightState = {
  height6: number;
  height5: number;
  height4: number;
  height3: number;
...
export declare type TimeLineOptionState = {
  fill?: boolean;
  width?: number;
  height?: number;
  bgColor?: string;
